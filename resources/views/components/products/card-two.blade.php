<div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
    ...
    <h1 class="mt-4 text-gray-800 text-3xl font-bold cursor-pointer">Write a Gatsby plugin using
        Typescript</h1>
    <div class="my-4">
        ...
        <button class="mt-4 text-xl w-full text-white bg-indigo-600 py-1.5 rounded-xl shadow-lg">Start
            Watching Now</button>
    </div>
</div>